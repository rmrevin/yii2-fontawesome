...
use rmrevin\yii\fontawesome\FontAwesomeException;
...
class Icon
{
	 ...
	 * @return self
	 * @throws \rmrevin\yii\fontawesome\FontAwesomeException
	 */
	public function size($value, $validate_value = true)
	{
		if ($validate_value === true && !in_array($value, [FA::SIZE_LARGE, FA::SIZE_2X, FA::SIZE_3X, FA::SIZE_4X, FA::SIZE_5X])) {
			throw new FontAwesomeException(\Yii::t('app', 'FA::size() - invalid value. Use one of the constants: FA::SIZE_LARGE, FA::SIZE_2X, FA::SIZE_3X, FA::SIZE_4X, FA::SIZE_5X.'));
		}
	...
	public function rotate($value, $validate_value = true)
	{
		if ($validate_value === true && !in_array($value, [FA::ROTATE_90, FA::ROTATE_180, FA::ROTATE_180])) {
			throw new FontAwesomeException(\Yii::t('app', 'FA::rotate() - invalid value. Use one of the constants: FA::ROTATE_90, FA::ROTATE_180, FA::ROTATE_180.'));
		}
	...
	public function flip($value, $validate_value = true)
	{
		if ($validate_value === true && !in_array($value, [FA::FLIP_HORIZONTAL, FA::FLIP_VERTICAL])) {
			throw new FontAwesomeException(\Yii::t('app', 'FA::flip() - invalid value. Use one of the constants: FA::FLIP_HORIZONTAL, FA::FLIP_VERTICAL.'));
		}
